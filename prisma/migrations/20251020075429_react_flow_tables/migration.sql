...
-- AddForeignKey
ALTER TABLE "Node" ADD CONSTRAINT "Node_worklowId_fkey" FOREIGN KEY ("worklowId") REFERENCES "Workflow"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Connection" ADD CONSTRAINT "Connection_worklowId_fkey" FOREIGN KEY ("worklowId") REFERENCES "Workflow"("id") ON DELETE CASCADE ON UPDATE CASCADE;
