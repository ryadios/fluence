...
export function GeminiDialog({ open, onOpenChange, onSubmit, defaultValues = {} }: Props) {
    const { data: credentails, isLoading: isLoadingCredentails } = useCredentialsByType(CredentialType.GEMINI);
