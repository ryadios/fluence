...
export function OpenAiDialog({ open, onOpenChange, onSubmit, defaultValues = {} }: Props) {
    const { data: credentails, isLoading: isLoadingCredentails } = useCredentialsByType(CredentialType.OPENAI);
